...
usage() {
	...
	echo
    echo -e "\tIf files are not specified, $(basename $0) formats all ".cpp" and ".hpp" files"
...
[[ $# != 0 ]] && src_files=$@ || src_files="--recursive $code_directory**.cpp,**.hpp --exclude=lnInclude"
...
# astyle formats of the src files.
astyle --style=bsd\
       --indent=spaces=4\
       --indent-classes\
       --indent-switches\
